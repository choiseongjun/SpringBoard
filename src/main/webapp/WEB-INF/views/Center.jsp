         ...
         <div class="our_partners_area py-70 pt_banner_30">
            <div class="container">
               ...
               <div class="partners wow fadeInUp">
                  <div class="item"><img src="${pageContext.request.contextPath}/assets/images/client_logo/client_logo-1.png" alt=""></div>
                  <div class="item"><img src="${pageContext.request.contextPath}/assets/images/client_logo/client_logo-2.png" alt=""></div>
                  <div class="item"><img src="${pageContext.request.contextPath}/assets/images/client_logo/client_logo-3.png" alt=""></div>
                  <div class="item"><img src="${pageContext.request.contextPath}/assets/images/client_logo/client_logo-4.png" alt=""></div>
                  <div class="item"><img src="${pageContext.request.contextPath}/assets/images/client_logo/client_logo-5.png" alt=""></div>
               </div>
         ...
         <div class="container">
            ...
            <div class="row about_row  py-40">
               ...
               <div class="who_we_area col-md-4 col-sm-6 col-4pad wow fadeInUp">
                  <div class="service-1">
                     <div class="servise-top wow fadeInUp">
                        <img src="${pageContext.request.contextPath}/assets/images/icone-1.png">
                     </div>
               ...
               <div class="who_we_area col-md-4 col-sm-6 col-4pad wow fadeInUp">
                  <div class="service-1">
                     <div class="servise-top wow fadeInUp">
                        <img src="${pageContext.request.contextPath}/assets/images/icone-2.png">
                     </div>
               ...
               <div class="who_we_area col-md-4 col-sm-6 col-4pad wow fadeInUp">
                  <div class="service-1">
                     <div class="servise-top wow fadeInUp">
                        <img src="${pageContext.request.contextPath}/assets/images/icone-3.png">
                     </div>
         ...
         <div class="container-fluid ">
            <div class="row text-left about_row   ">
               <div class="col-md-6 p-0 clip-polygon  ">
                  ...
                  <div class="video-img">
                     <a href="#nogo" class="hero__play"><img  src="${pageContext.request.contextPath}/assets/images/img-g.png"></a>
                  </div>
               </div>
            ...
            <div class="testimonial_carosel">
               <div class="item">
                  <div class="media">
                     <div class="media-left">
                        <a href="#">
                        <img class="media-object" src="${pageContext.request.contextPath}/assets/images/testimonial-3.jpg" alt="">
                        </a>
                     </div>
                  </div>
                  ...
                  <div class="media-body text-center">
                     ...
                     <div class="img-s ">
                        <img src="${pageContext.request.contextPath}/assets/images/logos-s.png">
                     </div>
                  </div>
               </div>
               <div class="item">
                  <div class="media">
                     <div class="media-left">
                        <a href="#">
                        <img class="media-object" src="${pageContext.request.contextPath}/assets/images/testimonial-2.jpg" alt="">
                        </a>
                     </div>
                  </div>
                  <p>Lorem Ipsum is simply dummy text of the printing and typesetting<br> industry. Lorem Ipsum has been the industry's standard dummy text<br> ever since the 1500s, </p>
               ...
               <div class="item">
                  <div class="media">
                     <div class="media-left">
                        <a href="#">
                        <img class="media-object" src="${pageContext.request.contextPath}/assets/images/testimonial-1.jpg" alt="">
                        </a>
                     </div>
                  </div>
                  <p>Lorem Ipsum is simply dummy text of the printing and typesetting<br> industry. Lorem Ipsum has been the industry's standard dummy text<br> ever since the 1500s, </p>

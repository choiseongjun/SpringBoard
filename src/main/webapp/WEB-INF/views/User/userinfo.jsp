    ...
    <div class="col-sm-8 col-sm-offset-2">
        <div class="panel panel-white profile-widget">
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="details">
                        <h4>${list.name }<i class="fa fa-sheild"></i></h4>
                        <div>Works at Bootdey.com</div>
                        <div>Attended University of Bootdey</div>
                        <div>Lives in Medellin, Colombia</div>
                        <div class="mg-top-10">
                            <a href="${path}/member/userinfoDetail.do/${list.userid}" class="btn btn-default">About ${list.name }</a>
                            <a href="#" class="btn btn-success">Add ${list.name }</a>
                        </div>
                    </div>
                </div>

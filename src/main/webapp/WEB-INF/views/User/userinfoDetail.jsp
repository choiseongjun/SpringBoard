...
<div class="profile-wrapper">
    <div class="profile-section-user">
        ...
        <div class="profile-info-brief p-3"><img class="img-fluid user-profile-avatar" src="http://bootdey.com/img/Content/avatar/avatar6.png" alt="">
            <div class="text-center">
                <h5 class="text-uppercase mb-4">${list.name }</h5>
            ...
            <div class="tab-pane active" id="profile-overview" role="tabpanel">
                ...
                <div class="stream-posts">
                    <div class="stream-post">
                        <div class="sp-author">
                            <a href="#" class="sp-author-avatar"><img src="http://bootdey.com/img/Content/avatar/avatar6.png" alt=""></a>

...
public class ReplyDTO {
	...
	public String toString() {
		return "ReplyDTO [rno=" + rno + ", bno=" + bno + ", replytext=" + replytext + ", replyer=" + replyer + ", name="
				...
				+ ", writer=" + writer + ", getRno()=" + getRno() + ", getBno()=" + getBno() + ", getReplytext()="
				+ getReplytext() + ", getReplyer()=" + getReplyer() + ", getName()=" + getName() + ", getRegdate()="
				+ getRegdate() + ", getUpdatedate()=" + getUpdatedate() + ", getSecret_reply()=" + getSecret_reply()
				+ ", getWriter()=" + getWriter() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode()
